"""
Shared Beer homework framework.

This keeps every homework-related tool aligned with Book 1, Chapter 34:
"การบ้านที่ไม่มีอาจารย์ตรวจ".
"""

HOMEWORK_FRAMEWORK_TITLE = "บทที่ 34 — การบ้านที่ไม่มีอาจารย์ตรวจ"
...
HOMEWORK_SEARCH_QUERY = (
    "การบ้านหุ้น เข้าใจธุรกิจ รายได้ กำไร หนี้ กระแสเงินสด ผู้บริหาร คู่แข่ง "
    "valuation conference call annual report filing ความเสี่ยง แผนการเทรด จุดที่คิดผิด"
)


def homework_prompt_block(market_label: str = "หุ้น") -> str:
...
def build_stock_homework_checklist(stock: dict) -> list[dict]:
    ...
    return [
        ...
        {
            "topic": "การสื่อสาร",
            "prompt": "หา earnings call, filing หรือ presentation ล่าสุดว่าผู้บริหารอธิบายอนาคตอย่างไร",
        },
        {
            "topic": "คู่แข่ง",
...
def homework_email_guide_html() -> str:
    items = build_stock_homework_checklist({"ticker": "หุ้น", "sector": "sector"})
    rows = "".join(
