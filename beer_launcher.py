...
class BeerLauncher:
    def __init__(self, root):
        ...
        self.btn_us = ttk.Button(root, text="Run US Top 100 (Homework)", command=lambda: self.run_agent("beer_top100_agent.py"))
        self.btn_us.pack(pady=10, fill=tk.X, padx=50)

        self.btn_th = ttk.Button(root, text="Run Thai Top 100 (การบ้านไทย)", command=lambda: self.run_agent("thai_top100_agent.py"))
